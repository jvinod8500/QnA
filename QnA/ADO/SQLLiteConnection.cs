...
namespace OneSourceService.ADO
{
    ...
    {
        private static string DatabaseFile = Path.GetDirectoryName(Assembly.GetExecutingAssembly().CodeBase).Replace("file:\\", "").Replace("bin", "") + "SQLlite.db";
        private string DatabaseSource = "data source=" + Path.GetDirectoryName(Assembly.GetExecutingAssembly().CodeBase).Replace("file:\\", "").Replace("bin", "") + "SQLlite.db";
